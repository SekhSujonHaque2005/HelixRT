    ...
    return (
        <header
            className={cn("sticky top-0 z-50 w-full border-b border-transparent", {
                "bg-white/95 dark:bg-slate-950/95 supports-[backdrop-filter]:bg-white/50 dark:supports-[backdrop-filter]:bg-slate-950/50 border-slate-200 dark:border-slate-800 backdrop-blur-lg":
                    scrolled,
            })}
        >
                    ...
                    <NavigationMenu className="hidden md:flex">
                        <NavigationMenuList>
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="bg-white dark:bg-slate-950 p-1 pr-1.5">
                                    <ul className="bg-white dark:bg-slate-950 grid w-[500px] grid-cols-2 gap-2 rounded-md border border-slate-200 dark:border-slate-800 p-2 shadow">
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent className="bg-white dark:bg-slate-950 p-1 pr-1.5 pb-1.5">
                                    <div className="grid w-[400px] grid-cols-2 gap-2">
                                        <ul className="bg-white dark:bg-slate-950 space-y-2 rounded-md border border-slate-200 dark:border-slate-800 p-2 shadow">
...
function MobileMenu({ open, children, className, ...props }: MobileMenuProps) {
    ...
    return createPortal(
        <div
            id="mobile-menu"
            className={cn(
                "bg-white/95 dark:bg-slate-950/95 supports-[backdrop-filter]:bg-white/50 dark:supports-[backdrop-filter]:bg-slate-950/50 backdrop-blur-lg",
